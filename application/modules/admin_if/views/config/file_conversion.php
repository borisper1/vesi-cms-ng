...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">Cartella temporanea</h3>
    </div>
    <div class="panel-body">
        <div class="form-group">
            <label for="i-temp-folder">Cartella temporanea per la conversione documenti:</label>
            <input type="text" class="form-control" id="i-temp-folder" placeholder="Inserire il percorso completo della cartella" value="<?=$temp_folder ?>">
            <span class="help-block">La cartella temporeana deve essere scrivibile dall'interprete PHP e da <code>pandoc</code>, è preferibile che si situata al di fuori dalle cartelle pubbliche oppure l'accesso sia proibito nella configurazione del server web. </span>
        </div>
        <button type="button" class="btn btn-sm btn-default"><i class="fa fa-key"></i> Controlla permessi</button>
    </div>
</div>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <span class="help-block">Il token è generato dal server e permette di identificare questo sito. Se il token non è corretto la connessione sarà rifutata dal server remoto</span>
        </div>
        ...
        Per una sicurezza migliore si consiglia di usare il protocollo <code>HTTPS (TLS 1.2)</code> sul server remoto per impedire l'intercettazione dei documenti.</p>
        <p>La chiave di autenticazione <code>HMAC-256</code> è impostabile nel file <code>application/config/file_coversion.json</code>. Questa chiave è generata dal server e deve rimanaere segreta (non va inviata con mezzi insciuri come e-mail o chat).
