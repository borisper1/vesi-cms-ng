$(document).ready(function () {
    ...
    $('#delete-users').click(function () {
        ...
        $.post(window.vbcknd.base_url + 'ajax/admin/users_legacy/delete', 'users=' + users.join(','), RefreshAJAXDone);
    });
    ...
    $('#enable-users').click(function () {
        ...
        $.post(window.vbcknd.base_url + 'ajax/admin/users_legacy/enable', 'users=' + users.join(','), RefreshAJAXDone);
    });
    ...
    $('#disable-users').click(function () {
        ...
        $.post(window.vbcknd.base_url + 'ajax/admin/users_legacy/disable', 'users=' + users.join(','), RefreshAJAXDone);
    });
    ...
    $('#new-user').click(function () {
        window.location = window.vbcknd.base_url + 'admin/users_legacy/edit/new';
    });

    $('#close-edit').click(function () {
        window.location = window.vbcknd.base_url + 'admin/users_legacy';
    });
    ...
    $('#delete-user').click(function () {
        $.post(window.vbcknd.base_url + 'ajax/admin/users_legacy/delete', 'users=' + $('#username').text(), DeleteUserDone);
    });
    ...
    $('#save-edit').click(function () {
        ...
        $.post(window.vbcknd.base_url + 'ajax/admin/users_legacy/save', data, SaveEditDone);
    });
    ...
    $('#save-edit-self').click(function () {
        ...
        $.post(window.vbcknd.base_url + 'ajax/admin/users_legacy/save_self', data, SaveEditDone);
    });
    ...
    $('#save-new').click(function () {
        ...
        $.post(window.vbcknd.base_url + 'ajax/admin/users_legacy/save', data, SaveNewDone);
    });
