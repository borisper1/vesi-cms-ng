ace.define("ace/mode/css_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    function a() {
        ...
        this.$rules.jsx = [n, t, {include: "reference"}, {defaultToken: "string"}], this.$rules.jsxAttributes = [{
            ...
            nextState: "jsx"
        }, n, {token: "entity.other.attribute-name.xml", regex: e}, {
            ...
            push: [{
                ...
                regex: "'",
                next: "pop"
            }, n, {include: "reference"}, {defaultToken: "string.attribute-value.xml"}]
        }, {
            token: "string.attribute-value.xml",
            regex: '"',
    ...
    var r = e("../lib/oop"), i = e("./doc_comment_highlight_rules").DocCommentHighlightRules, s = e("./text_highlight_rules").TextHighlightRules, o = "[a-zA-Z\\$_\u00a1-\uffff][a-zA-Z\\d\\$_\u00a1-\uffff]*\\b", u = function (e) {
        ...
        }, "identifier"), n = "case|do|else|finally|in|instanceof|return|throw|try|typeof|yield|void", r = "\\\\(?:x[0-9a-fA-F]{2}|u[0-9a-fA-F]{4}|[0-2][0-7]{0,2}|3[0-6][0-7]?|37[0-7]?|[4-7][0-7]?|.)";
        this.$rules = {
            no_regex: [{
                token: "comment",
                regex: "\\/\\/",
    ...
    var r = e("../lib/oop"), i = e("../lib/lang"), s = e("./html_highlight_rules").HtmlHighlightRules, o = e("./text_highlight_rules").TextHighlightRules, u = function () {
        ...
        var t = "addslashes|capitalize|date|default|escape|first|groupBy|join|json|last|lower|raw|replace|reverse|safe|sort|striptags|title|uniq|upper|url_encode|url_decode", n = "first|last|index|index0|revindex|revindex0|key", r = "null|none|true|false|loop", i = "in|is|and|or|not|as|with|only", o = this.createKeywordMapper({
        ...
        this.$rules["swig-comment"] = [{
            ...
            regex: '"',
            next: "swig-start"
        }, {defaultToken: "string"}], this.$rules["swig-qstring"] = [{
            token: "constant.language.escape",
            regex: /\\[\\'ntr]}/
        }, {token: "string", regex: "'", next: "swig-start"}, {defaultToken: "string"}], this.normalizeRules()
    };
