ace.define("ace/keyboard/vim", ["require", "exports", "module", "ace/range", "ace/lib/event_emitter", "ace/lib/dom", "ace/lib/oop", "ace/lib/keys", "ace/lib/event", "ace/search", "ace/lib/useragent", "ace/search_highlight", "ace/commands/multi_select_commands", "ace/mode/text", "ace/multi_select"], function (e, t, n) {
    ...
    function Ft(e, t) {
        var n = [], r = e.listSelections(), i = Lt(e.clipPos(t)), s = !At(t, i), o = e.getCursor("head"), u = qt(r, o), a = At(r[u].head, r[u].anchor), f = r.length - 1, l = f - u > u ? f : 0, c = r[l].anchor, h = Math.min(c.line, i.line), p = Math.max(c.line, i.line), d = c.ch, v = i.ch, m = r[l].head.ch - d, g = v - d;
    ...
    function Rt(e, t) {
        var n = t.lastSelection, r = function () {
            var t = e.listSelections(), n = t[0], r = t[t.length - 1], i = Ot(n.anchor, n.head) ? n.anchor : n.head, s = Ot(r.anchor, r.head) ? r.head : r.anchor;
            return [i, s]
        }, i = function () {
    ...
    function nn(e, t, n, r) {
        var i = Lt(e.getCursor()), s = n ? 1 : -1, o = n ? e.lineCount() : -1, u = i.ch, a = i.line, f = e.getLine(a), l = {
            lineText: f,
            nextCh: f.charAt(u),
            lastCh: null,
            index: u,
    ...
    function Sn(e) {
        ...
        while (!t.eol()) {
            ...
            var r = !1;
            for (var i in En)if (t.match(i, !0)) {
                r = !0, n.push(En[i]);
                break
            }
            r || n.push(t.next())
    ...
    function kn(e, t) {
        var n = (t.prefix || "") + " " + (t.desc || ""), r = Nn(t.prefix, t.desc);
    ...
    function qn(e) {
        var t = e.state.vim, n = nt.macroModeState, r = nt.registerController.getRegister("."), i = n.isPlaying, s = n.lastInsertModeChanges, o = [];
        if (!i) {
    ...
    function Yn(e) {
        function i() {
            return n.changes.push(new Gn(r)), !0
        }
    ...
    function er(e, t, n) {
        ...
        for (var f = 0; f < n; f++) {
            ...
            for (var l = 0; l < t.length; l++) {
                var c = t[l];
                if (c instanceof Gn)v.lookupKey(c.keyName, "vim-insert", r); else {
                    var h = e.getCursor();
        ...
        if (t == "<Esc>" && !i.insertMode && !i.visualMode && e.ace.inMultiSelectMode)e.ace.exitMultiSelectMode(); else if (s || !e.ace.inMultiSelectMode || e.ace.inVirtualSelectionMode)r = S.handleKey(e, t, n); else {
            ...
            e.operation(function () {
                e.ace.forEachSelection(function () {
                    ...
                    var s = e.getCursor("head"), u = e.getCursor("anchor"), a = Ot(s, u) ? 0 : -1, f = Ot(s, u) ? -1 : 0;
    ...
    v.Pos = function (e, t) {
        ...
        u.implement(v.prototype, s), this.destroy = function () {
            ...
            if (e.action[0] == "i") {
                var t = {text: e.lines}, n = this.curOp = this.curOp || {};
    ...
    var L = {Shift: "S", Ctrl: "C", Alt: "A", Cmd: "D", Mod: "A"}, A = {
        Enter: "CR",
        Backspace: "BS",
        Delete: "Del"
    }, _ = /[\d]/, D = [v.isWordChar, function (e) {
        return e && !v.isWordChar(e) && !/\s/.test(e)
    }], P = [function (e) {
        return /\S/.test(e)
    }], B = H(65, 26), j = H(97, 26), F = H(48, 10), I = [].concat(B, j, F, ["<", ">"]), q = [].concat(B, j, F, ["-", '"', ".", ":", "/"]), J = {};
    ...
    var nt, it, st = {
        ...
        findKey: function (e, t, n) {
            ...
            function u() {
                if (s())return !0;
                var n = r.inputState.keyBuffer = r.inputState.keyBuffer + t, i = t.length == 1, o = ht.matchCommand(n, b, r.inputState, "insert");
    ...
    var ht = {
        matchCommand: function (e, t, n, r) {
            ...
            var n = t.inputState, r = n.motion, i = n.motionArgs || {}, s = n.operator, o = n.operatorArgs || {}, u = n.registerName, a = t.sel, f = Lt(t.visualMode ? wt(e, a.head) : e.getCursor("head")), l = Lt(t.visualMode ? wt(e, a.anchor) : e.getCursor("anchor")), c = Lt(f), h = Lt(l), p, d, v;
        ...
        moveToTopLine: function (e, t, n) {
            ...
            var t = Hn(e), n = Math.floor((t.top + t.bottom) * .5);
            ...
            var r = nt.lastChararacterSearch, i = n.repeat, s = n.forward === r.forward, o = (r.increment ? 1 : 0) * (s ? -1 : 1);
        ...
        change: function (e, t, n) {
            ...
            var i = e.state.vim, s = e.getSelection(), o = i.visualMode ? Mt(i.sel.anchor, i.sel.head, n[0].head, n[0].anchor) : r;
        ...
        jumpListWalk: function (e, t, n) {
            ...
            if (n.visualMode)return;
            var r = t.repeat || 1, i = e.defaultTextHeight(), s = e.getScrollInfo().top, o = i * r, u = t.forward ? s + o : s - o, a = Lt(e.getCursor()), f = e.charCoords(a, "local");
            ...
            var n = e.getCursor().line, r = e.charCoords(E(n, 0), "local"), i = e.getScrollInfo().clientHeight, s = r.top, o = r.bottom - s;
            switch (t.position) {
                case"center":
                    s = s - i / 2 + o;
                    break;
            ...
            if (!f)return;
            var l = t.increase ? 1 : -1, c = parseInt(f) + l * t.repeat, h = E(n.line, o), p = E(n.line, u);
    ...
    var bn = {"\\n": "\n", "\\r": "\r", "\\t": "	"}, En = {
        ...
        "\\r": "\r",
        "\\t": "	"
    }, Cn = "(Javascript regexp)", Bn = function () {
    ...
    var jn = {
        colorscheme: function (e, t) {
            ...
            var n = t.argString, r = n ? mn(n) : [], i, s = "", o, u, a, f = !1, l = !1;
            if (r.length)i = r[0], s = r[1], s !== undefined && (G("pcre") ? s = Sn(s) : s = wn(s), nt.lastSubstituteReplacePart = s), o = r[2] ? r[2].split(" ") : []; else if (n && n.length) {
    ...
    t.handler = {
        $id: "ace/keyboard/vim", drawCursor: function (e, t, n, r, s) {
            ...
            var s = e.editor, o = s.state.cm, u = or(o);
            if (r == -1)return;
            if (n == "c" && t == 1) {
