ace.define("ace/mode/css_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    r.inherits(l, i), function () {
        this.lineCommentStart = "#", this.getNextLineIndent = function (e, t, n) {
            ...
            if (s.length && s[s.length - 1].type == "comment")return r;
            if (e == "start") {
                var o = t.match(/^.*[\{\(\[]\s*$/), u = t.match(/^\s*(class|def|module)\s.*$/), a = t.match(/.*do(\s*|\s+\|.*\|\s*)$/), f = t.match(/^\s*(if|else|when)\s*/);
                if (o || u || a || f)r += n
            }
            return r
        }, this.checkOutdent = function (e, t, n) {
    ...
    var r = e("../lib/oop"), i = e("./html_highlight_rules").HtmlHighlightRules, s = e("./javascript_highlight_rules").JavaScriptHighlightRules, o = function (e, t) {
        ...
        this.embedRules(s, "ejs-", [{token: "markup.list.meta.tag", regex: "-?" + t, next: "pop"}, {
            token: "comment",
            regex: "//.*?" + t,
            next: "pop"
        }]), this.normalizeRules()
