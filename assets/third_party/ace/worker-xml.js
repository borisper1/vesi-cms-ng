...
(function (e) {
    ...
    function y(e, t, n) {
        ...
        while (o--) {
            ...
            if (l > 0)var c = u.prefix = a.slice(0, l), h = a.slice(l + 1), p = c === "xmlns" && h; else h = a, c = null, p = a === "xmlns" && "";
    ...
    function $(e, t) {
        if (t(e))return !0;
        if (e = e.firstChild)do if ($(e, t))return !0; while (e = e.nextSibling)
    }
        ...
        switch (e.nodeType) {
            case u:
                ...
                if (i || h && !/^(?:meta|link|img|br|hr|input|button)$/i.test(o)) {
                    t.push(">");
                    if (h && /^script$/i.test(o))i && t.push(i.data); else while (i)dt(i, t), i = i.nextSibling;
                    t.push("</", o, ">")
                } else t.push("/>");
                return;
            case v:
    ...
    B.prototype = Error.prototype, r(b, B), j.prototype = {
        ...
        length: 0, item: j.prototype.item, getNamedItem: function (e) {
            var t = this.length;
            while (t--) {
                var n = this[t];
        ...
        nodeType: u, hasAttribute: function (e) {
        ...
        nodeName: "#text", nodeType: f, splitText: function (e) {
